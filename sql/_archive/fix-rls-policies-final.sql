-- Script para corrigir as políticas RLS de forma definitiva
...
WITH simulated_auth AS (
  SELECT 'bd0dd7f6-55fe-4c28-ac90-368addcb5f9b'::text as uid
)
...
WHERE 
  ...
  (t.created_by = simulated_auth.uid
   OR t.assigned_users @> ARRAY[simulated_auth.uid]
...
SELECT 'SUCCESS: RLS policies updated! Test the application now.' as result; 