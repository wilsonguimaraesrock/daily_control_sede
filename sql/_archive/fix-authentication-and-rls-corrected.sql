-- Correção Final: Autenticação e Políticas RLS (CORRIGIDO)
...
-- PASSO 2: Remover TODAS as políticas existentes para user_profiles
DO $$
DECLARE
    policy_record RECORD;
BEGIN
    -- Buscar todas as políticas da tabela user_profiles
    ...
    LOOP
        EXECUTE format('DROP POLICY IF EXISTS %I ON user_profiles', policy_record.policy_name);
        RAISE NOTICE 'Removed policy: %', policy_record.policy_name;
    END LOOP;
END $$;
